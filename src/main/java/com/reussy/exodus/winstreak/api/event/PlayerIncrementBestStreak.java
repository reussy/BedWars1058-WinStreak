package com.reussy.exodus.winstreak.api.event;
 ...
 */
public class PlayerIncrementBestStreak extends Event implements Cancellable {
    ...
    public PlayerIncrementBestStreak(IUser user, int oldStreak, int newStreak) {
        this.user = user;
